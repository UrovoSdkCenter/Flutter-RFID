...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _enableScanHead() async {
    setState(() {
      info = "_enableScanHead";
    });
    await urovoRfidPlugin.enableScanHead(true);
  }

  void _disableScanHead() async {
    setState(() {
      info = "_disableScanHead";
    });
    await urovoRfidPlugin.enableScanHead(false);
  }
      ...
      body: Column(
        ...
        children: <Widget>[
          Wrap(spacing: 10, children: <Widget>[
            ...
            ElevatedButton(
              onPressed: _enableScanHead,
              child: const Text("Enable_ScanHead"),
            ),
            ElevatedButton(
              onPressed: _disableScanHead,
              child: const Text("Disable_ScanHead"),
            ),
            ElevatedButton(
