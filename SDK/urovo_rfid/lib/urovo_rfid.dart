...
class UrovoRfid {
  ...
  Future<void> enableScanHead(bool isOpen) async {
    await UrovoRfidPlatform.instance.enableScanHead(isOpen);
  }
  ...
  Future<String?> readTag(
      String epc, int memBank, int wordAdd, int wordCnt, String pwArr) {
  ...
  Future<int?> writeTag(String epc, String btAryPassWord, int btMemBank,
      int btWordAdd, int btWordCnt, String btAryData) {
  ...
  Future<int?> writeTagByTid(
      String tidStr, int mem, int wordPtr, String password, String wdata) {
    return UrovoRfidPlatform.instance
  ...
  Future<int?> killbyTID(int tidlen, String tid, String btAryPassWord) {
    return UrovoRfidPlatform.instance.killbyTID(tidlen, tid, btAryPassWord);
  }

  Future<int?> lockTag(
      String epc, String btAryPassWord, int btMemBank, int btLockType) {
    return UrovoRfidPlatform.instance
  ...
  Future<int?> iso180006BReadTag(
      String btAryUID, int btWordAdd, int btWordCnt) {
    return UrovoRfidPlatform.instance
        .iso180006BReadTag(btAryUID, btWordAdd, btWordCnt);
  }

  Future<int?> iso180006BWriteTag(
      String btAryUID, int btWordAdd, int btWordCnt, String btAryBuffer) {
    return UrovoRfidPlatform.instance
