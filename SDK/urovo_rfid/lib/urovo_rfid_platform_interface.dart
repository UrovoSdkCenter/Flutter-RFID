...
abstract class UrovoRfidPlatform extends PlatformInterface {
  ...
  Future<int?> writeTagByTid(
      String tidStr, int mem, int wordPtr, String password, String data) {
  ...
  Future<int?> lockbyTID(int tidlen, String tid, int btMemBank,
      int btLockType, String btAryPassWord) {
