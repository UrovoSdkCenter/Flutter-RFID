...
class MethodChannelUrovoRfid extends UrovoRfidPlatform {
  ...
  @override
  Future<void> enableScanHead(bool isOpen) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['isOpen'] = isOpen;
    await methodChannel.invokeMethod("enableScanHead", param);
  }
  ...
  Future<int?> iso180006BWriteTag(
      String btAryUID, int btWordAdd, int btWordCnt, String btAryBuffer) async {
    Map<String, dynamic> param = <String, dynamic>{};
  ...
  Future<int?> iso180006BReadTag(
      String btAryUID, int btWordAdd, int btWordCnt) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['btAryUID'] = btAryUID;
    param['btWordAdd'] = btWordAdd;
    param['btWordCnt'] = btWordCnt;
  ...
  @override
  Future<int?> iso180006BQueryLockTag(String btAryUID, int btWordAdd) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['btAryUID'] = btAryUID;
    param['btWordAdd'] = btWordAdd;
  ...
  @override
  Future<int?> iso180006BLockTag(String btAryUID, int btWordAdd) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['btAryUID'] = btAryUID;
    param['btWordAdd'] = btWordAdd;
  ...
  @override
  Future<int?> lockbyTID(int tidlen, String tid, int btMemBank, int btLockType,
      String btAryPassWord) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['tidlen'] = tidlen;
    param['tid'] = tid;
  ...
  @override
  Future<int?> lockTag(
      String epc, String btAryPassWord, int btMemBank, int btLockType) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['epc'] = epc;
    param['btAryPassWord'] = btAryPassWord;
    param['btMemBank'] = btMemBank;
  ...
  @override
  Future<int?> killbyTID(int tidlen, String tid, String btAryPassWord) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['tidlen'] = tidlen;
    param['tid'] = tid;
    param['btAryPassWord'] = btAryPassWord;
  ...
  @override
  Future<int?> killTag(String epc, String btAryPassWord) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['epc'] = epc;
    param['btAryPassWord'] = btAryPassWord;
  ...
  @override
  Future<int?> WriteEPC(int epcLen, String epc, String password) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['epc'] = epc;
    param['epcLen'] = epcLen;
  ...
  Future<int?> writeTagByTid(
      String tidStr, int mem, int wordPtr, String password, String data) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['tidStr'] = tidStr;
    param['mem'] = mem;
  ...
  @override
  Future<int?> writeTag(String epc, String btAryPassWord, int btMemBank,
      int btWordAdd, int btWordCnt, String btAryData) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['epc'] = epc;
    param['btAryPassWord'] = btAryPassWord;
    param['btMemBank'] = btMemBank;
  ...
  Future<String?> readTag(
      String epc, int memBank, int wordAdd, int wordCnt, String pwArr) async {
    Map<String, dynamic> param = <String, dynamic>{};
    param['epc'] = epc;
